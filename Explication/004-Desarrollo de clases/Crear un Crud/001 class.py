...
while True:
    ...
    if opcion ==1:
        ...
        productos = Producto() # creamos una nueba instaciu de la clase
        productos.nombre = input("Introsude el nombre del producto ") #Esrivo la proppiedad de la nombre
        productos.precio = input("Introduce del producto:") # Esribo la propiedad de la precio
        productos.append = 
